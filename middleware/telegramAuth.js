...
async function telegramAuth(req, res, next) {
  try {
    ...
    // Banned users ko app access na milne dena — poore backend ke liye ek hi jagah check
    const existing = await User.findOne({ telegramId: String(user.id) }).select("isBanned");
