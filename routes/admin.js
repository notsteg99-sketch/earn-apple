...
// POST /api/admin/settings  body: { adRewardApple, referralBonusApple, referralCommissionRate }
router.post("/settings", async (req, res) => {
  try {
    const { adRewardApple, referralBonusApple, referralCommissionRate } = req.body;
    const settings = await getSettings();
