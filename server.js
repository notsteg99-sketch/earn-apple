...
const app = express();
app.set("trust proxy", true); // Railway ke peeche real client IP milne ke liye (X-Forwarded-For se)
app.use(cors());
...
app.use("/api/leaderboard", require("./routes/leaderboard")); // top users by APPLE balance
